...
In class, we saw the command `ls -l` which lists the contents of a directory in so-called "long"
form. This form shows ownership properties and permissions of files and directories. Here's what
the output of `ls -l` in my home directory looks like:
